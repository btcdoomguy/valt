...
[TestFixture]
public class CreditTransactionEditorViewModelTests
{
    private CreditTransactionEditorViewModel _viewModel;

    [SetUp]
    public void SetUp()
    {
        _viewModel = new CreditTransactionEditorViewModel();
    ...
    [Test]
    public void Validate_ShouldPass_WhenFromBtcValueProvided()
    {
        _viewModel.FromAccount = CreateBtcAccount("2", "BTC");

...
public class BrazilianRuleCalculationStrategyTests
{
    ...
    public void Should_Calculate_Avg_Price_For_Single_Buy()
    {
        ...
        var line = AvgPriceLineBuilder.ABuyLine()
            ...
            .WithBtcAmount(BtcValue.ParseBitcoin(0.1m))
        ...
        Assert.That(line.Totals.BtcAmount.Btc, Is.EqualTo(0.1m));
    ...
    public void Should_Calculate_Avg_Price_For_Multiple_Buys_At_Different_Prices()
    {
        ...
        var line2 = AvgPriceLineBuilder.ABuyLine()
            ...
            .WithDisplayOrder(1)
            .WithBtcAmount(BtcValue.ParseBitcoin(0.2m))
        ...
        Assert.That(line1.Totals.BtcAmount.Btc, Is.EqualTo(0.1m));
        ...
        Assert.That(line2.Totals.BtcAmount.Btc, Is.EqualTo(0.3m));
    ...
    public void Should_Calculate_Avg_Price_After_Partial_Sell()
    {
        ...
        var sellLine = AvgPriceLineBuilder.ASellLine()
            ...
            .WithBitcoinUnitPrice(FiatValue.New(60000m)) // Sell price doesn't affect avg in Brazilian rule
            .Build();
        ...
        Assert.That(buyLine.Totals.BtcAmount.Btc, Is.EqualTo(1m));
    ...
    public void Should_Calculate_Avg_Price_For_Buy_Sell_Buy_Sequence()
    {
        ...
        var buy1 = AvgPriceLineBuilder.ABuyLine()
            .WithDate(new DateOnly(2024, 1, 1))
            .WithBtcAmount(BtcValue.ParseBitcoin(1m))
            .WithBitcoinUnitPrice(FiatValue.New(40000m))
            .Build();
        ...
        var buy2 = AvgPriceLineBuilder.ABuyLine()
            ...
            .WithBtcAmount(BtcValue.ParseBitcoin(0.3m))
            .WithBitcoinUnitPrice(FiatValue.New(60000m))
            .Build();
        ...
        Assert.That(buy1.Totals.BtcAmount.Btc, Is.EqualTo(1m));
        ...
        Assert.That(sell.Totals.BtcAmount.Btc, Is.EqualTo(0.5m));
        ...
        Assert.That(buy2.Totals.BtcAmount.Btc, Is.EqualTo(0.8m));
    ...
    public void Should_Handle_Sell_All_And_Then_Buy_Again()
    {
        ...
        var buy2 = AvgPriceLineBuilder.ABuyLine()
            .WithDate(new DateOnly(2024, 1, 3))
            .WithBtcAmount(BtcValue.ParseBitcoin(0.5m))
            .WithBitcoinUnitPrice(FiatValue.New(70000m))
            .Build();
        ...
        Assert.That(sell.Totals.BtcAmount.Btc, Is.EqualTo(0m));
        ...
        Assert.That(buy2.Totals.BtcAmount.Btc, Is.EqualTo(0.5m));
    ...
    public void Should_Override_Values_With_Setup_Line()
    {
        ...
        var setup = AvgPriceLineBuilder.ASetupLine()
            .WithDate(new DateOnly(2024, 1, 2))
            .WithBtcAmount(BtcValue.ParseBitcoin(2m)) // New BTC amount
            .WithBitcoinUnitPrice(FiatValue.New(45000m)) // New avg price
            .Build();
        ...
        Assert.That(buy.Totals.BtcAmount.Btc, Is.EqualTo(1m));
        ...
        Assert.That(setup.Totals.BtcAmount.Btc, Is.EqualTo(2m));
    ...
    public void Should_Continue_Calculations_After_Setup()
    {
        ...
        Assert.That(setup.Totals.BtcAmount.Btc, Is.EqualTo(1m));
        ...
        Assert.That(buy.Totals.BtcAmount.Btc, Is.EqualTo(1.5m));
    ...
    public void Should_Handle_Multiple_Buys_Same_Day_With_Display_Order()
    {
        ...
        Assert.That(buy1.Totals.BtcAmount.Btc, Is.EqualTo(0.5m));

        // After buy2: Total = 25000 + 30000 = 55000, BTC = 1, Avg = 55000
        Assert.That(buy2.Totals.TotalCost, Is.EqualTo(55000m));
        Assert.That(buy2.Totals.BtcAmount.Btc, Is.EqualTo(1m));
    ...
    public void Should_Calculate_With_Small_Bitcoin_Amounts()
    {
        ...
        var line = AvgPriceLineBuilder.ABuyLine()
            .WithDate(new DateOnly(2024, 1, 1))
            .WithBtcAmount(BtcValue.ParseBitcoin(0.001m))
            .WithBitcoinUnitPrice(FiatValue.New(50000m))
            .Build();
        ...
        Assert.That(line.Totals.BtcAmount.Btc, Is.EqualTo(0.001m));
        Assert.That(line.Totals.AvgCostOfAcquisition.Value, Is.EqualTo(50000m));
    }
}

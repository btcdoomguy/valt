...
[TestFixture]
public class TransactionRepository_FiatTransactionTests : DatabaseTest
{
    ...
    [Test]
    public async Task Should_Store_And_Retrieve_Credit_FiatTransaction()
    {
    ...
    [Test]
    public async Task Should_Store_And_Retrieve_Debt_FiatTransaction()
    {
        var transaction = new TransactionBuilder()
        {
            CategoryId = _categoryId,

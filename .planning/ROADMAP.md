...
- [ ] **Phase 29: Domain, Persistence, and Active-View Filtering** - Add sold state to the asset aggregate, persistence, and queries; ensure sold assets are excluded from active views, totals, and price updates.
